...
public class CameraAlongPathWorldLockedEffect extends TriggerEffect {

    private static final float DEFAULT_LERP_SPEED = 0.15F;
    private static final double MIN_PATH_LENGTH_SQUARED = 1.0E-8;

    @Nonnull
    public static final BuilderCodec<CameraAlongPathWorldLockedEffect> CODEC =
            BuilderCodec.builder(
                            CameraAlongPathWorldLockedEffect.class,
                            CameraAlongPathWorldLockedEffect::new,
                            BASE_CODEC
                    )
                    .append(
    ...
    public void execute(@Nonnull TriggerContext context) {
        ...
        Direction cameraRotation = new Direction(
